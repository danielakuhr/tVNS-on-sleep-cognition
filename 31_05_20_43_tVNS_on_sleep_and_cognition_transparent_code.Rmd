...
#Boxplots for each stimulation condition on pre- and post-nap measurement
p2 <- ggplot(df_dec, aes(x = factor(time), y = value_z, color = factor(stimulation_condition))) +
...
ggsave("Declarative_Boxplots.png", plot = p1, width = 10, height = 6, dpi = 900)

#Plots with Means, Error Bars, And Rainclouds
p01 <- df_dec %>% 
...
#Spagetti-Plot for tVNS Condition.
...
# Spagetti-Plot with all three conditions on top of each other (Unfortunately, I did not manage to plot them beautifully beside each other)
...
#### Identifying the best model orientating at the code by Obleser et al. (2021)
```{r  include=FALSE}
...
# get Obleser et al.'s libraries locked and loaded:
...
ggsave("Boxplots_cortisol.png", plot = p6, width = 10, height = 6, dpi = 900)
